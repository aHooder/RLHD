...
public class RenderState {
	...
	public static class GLBindFrameBuffer extends GLState.PrimitiveArrayState<RenderState, Integer> {
		protected GLBindFrameBuffer() { super(() -> new Integer[2]); }
		@Override protected void applyValues(Integer[] values) { glBindFramebuffer(values[0], values[1]); }
	}

	public static class GLBindVAO extends GLState.SingleState<RenderState, Integer> {
		@Override protected void applyValue(Integer vao) { glBindVertexArray(vao); }
	}

	public static class GLBindEBO extends GLState.SingleState<RenderState, Integer> {
		@Override protected void applyValue(Integer ebo) { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ebo); }
	}

	public static class GLBindUBO extends GLState.SingleState<RenderState, Integer> {
		@Override protected void applyValue(Integer ubo) { glBindBuffer(GL_UNIFORM_BUFFER, ubo); }
	}

	public static class GLBindIDO extends GLState.SingleState<RenderState, Integer> {
		@Override protected void applyValue(Integer ido) { glBindBuffer(GL_DRAW_INDIRECT_BUFFER, ido); }
	}

	public static class GLDepthMask extends GLState.SingleState<RenderState, Boolean> {
		@Override protected void applyValue(Boolean enabled) { glDepthMask(enabled); }
	}

	public static class GLDepthFunc extends GLState.SingleState<RenderState, Integer> {
		@Override protected void applyValue(Integer func) { glDepthFunc(func); }
	}

	public static class GLBlendFunc extends GLState.PrimitiveArrayState<RenderState, Integer> {
		protected GLBlendFunc() { super(() -> new Integer[4]); }
		@Override
		protected void applyValues(Integer[] values) {glBlendFuncSeparate(values[0], values[1], values[2], values[3]); }
	}

	public static class GLColorMask extends GLState.PrimitiveArrayState<RenderState, Boolean> {
		protected GLColorMask() { super(() -> new Boolean[4]); }
		@Override
		protected void applyValues(Boolean[] values) {glColorMask(values[0], values[1], values[2], values[3]); }
	}

	public static class GLEnable extends GLState.GLFlagSetState<RenderState> {
	...
	public static class GLDisable extends GLState.GLFlagSetState<RenderState> {
